...
| **n8n + 9 workflows** | le cerveau (lit, écrit, rédige, route, source, tracke, alerte) | ta machine (`localhost:5678`) |
...
## Phase 2 — Le cerveau : n8n local + les 9 workflows (25 min)
...
### 2.3 Importer les 9 workflows (dans cet ordre)
...
**Puis branche l'alerte** : sur **chacun** des workflows 1 à 8, ouvre le
